...
class Habit(db.Model):
    ...
    created_at = db.Column(db.DateTime, default=db.func.current_timestamp())
    #description = db.Column(db.String(200), nullable=False) #principales
    #created_at = db.Column(db.DateTime, default=datetime.utcnow) #principales

    #tracking_records = db.relationship(
    #    'HabitTracking', backref='habits', lazy=True)
